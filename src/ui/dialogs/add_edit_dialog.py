...
class AddEditDialog(QDialog):
    ...
    def _populate_drive_combo(self, preselect: str = None):
        ...
        self._drive_combo.addItem("Auto (auto-select)", "AUTO")
        ...
        if self._connection and self._connection.drive_letter.upper() != "AUTO":
    ...
    def get_connection(self) -> Connection:
        ...
        drive = self._drive_combo.currentData() or "AUTO"
